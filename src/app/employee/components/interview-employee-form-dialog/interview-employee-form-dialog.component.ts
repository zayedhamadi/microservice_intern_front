...
@Component({
  selector: 'app-interview-employee-form-dialog',
  templateUrl: './interview-employee-form-dialog.component.html',
  styleUrl: './interview-employee-form-dialog.component.css',
})
export class InterviewEmployeeFormDialogComponent {
  form: FormGroup;
  isEdit = false;
  saving = false;
