...
export class ListUsersComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.searchSubject
      ...
      .subscribe({
        ...
        error: (err: any) => {
          console.error('[ListUsers RH] Erreur pipeline de recherche :', err);
          this.isSearching = false;
        },
      });
  }
  ...
  loadUsers(): void {
    ...
    this.userService
      ...
      .subscribe({
        ...
        error: (err: any) => {
          console.error(
            '[ListUsers RH] Erreur de chargement des utilisateurs disponibles :',
            err,
          );
          this.isLoading = false;
  ...
  loadInactifUsers(): void {
    ...
    this.userService
      ...
      .subscribe({
        ...
        error: (err: any) => {
          console.error(
            '[ListUsers RH] Erreur de chargement des utilisateurs inactifs :',
            err,
          );
          this.isLoadingInactif = false;
  ...
  loadImageForUser(u: any): void {
    ...
    this.userService
      ...
      .subscribe({
        ...
        error: (err: any) => {
          console.error(
            "[ListUsers RH] Erreur lors du chargement de l'image",
            u.id,
            err,
          );
        },
  ...
  viewProfile(u: any): void {
    this.router.navigate(['../consulterprofilUser', u.id], {
      relativeTo: this.route,
    });
  }

  backToDashboard(): void {
    this.router.navigate(['../dashboardRH'], { relativeTo: this.route });
  }
